...
AchievementSystem.achievementsClassic = {
    ...
    },
    {
        ...
        targetValue = 2,
        condition = function(achievement, stats)
            return BPP_IsAchievementUnlocked("gender_gender_female_4") and
                   BPP_IsAchievementUnlocked("gender_gender_male_4")
        end,
        unlocked = false,
        completedDate = nil,
        subText = function(a)
        ...
        progress = function(achievement, stats)
            local female = BPP_IsAchievementUnlocked("gender_gender_female_4") and 1 or 0
            local male = BPP_IsAchievementUnlocked("gender_gender_male_4") and 1 or 0
            return female + male
        end,
    },
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236814",
        achievementPoints = 0,
        targetValue = 10000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Redridge Mountains")
        end,
    },
        {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236665",
        achievementPoints = 0,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Earn %d achievement points"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236668",
        achievementPoints = 0,
        targetValue = 8000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Earn %d achievement points"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236670",
        achievementPoints = 0,
        targetValue = 16000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236682",
        achievementPoints = 0,
        targetValue = 50,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Unlock %d achievements"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236683",
        achievementPoints = 0,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Unlock %d achievements"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236685",
        achievementPoints = 0,
        targetValue = 150,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Unlock %d achievements"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236686",
        achievementPoints = 0,
        targetValue = 200,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        iconID = 132293, -- spell_shadow_shadowfury
        achievementPoints = 10,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Get %d player kills"):format(a.targetValue) end,
        iconID = 135974, -- spell_shadow_shadowfury
        achievementPoints = 25,
        targetValue = 1000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            ...
            local savedAchievements = BPP_DB.CharacterAchievements and BPP_DB.CharacterAchievements[characterKey] or {}
            local rangeIds = {
...

    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236447",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Eliminate %d Humans"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236448",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Eliminate %d Night Elves"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236450",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
...

    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236443",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
...

    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236445",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Eliminate %d Gnomes"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236446",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
...

    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236451",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Eliminate %d Orcs"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236452",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
...

    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236457",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        title = "Zombies't",
        description = function(a) return ("Eliminate %d Undead"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236458",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
...

    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236455",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
...

    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236453",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        title = "No More Bull",
        description = function(a) return ("Eliminate %d Tauren"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236454",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236592",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetProgressForAllianceRacesClassic(stats)
        end,
    },
    {
    ...
    -- HORDE MIXED RACE ACHIEVEMENTS
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\255132",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetProgressForHordeRacesClassic(stats)
        end,
    },
    {
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetProgressForAchievementWithAllClasses(stats, BPP_GAME_VERSIONS.CLASSIC)
        end,
    },
    {
    ...
    },
    {
        ...
        title = "Thumbs up!",
        description = function(a) return ("Achieve a %d-player kill streak"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236375",
        achievementPoints = 250,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        subText = function(a)
            ...
            local stats = BPP_CalculateSummaryStatistics(charactersToProcess)
    ...
    },
    {
        ...
        title = "PENTAKILL!!",
        description = function(a) return ("Get %d kills in a single combat"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236383",
        achievementPoints = 100,
        targetValue = 5,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        description = function(a) return ("Get %d kills in a single combat"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236381",
        achievementPoints = 250,
        targetValue = 10,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Durotar")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "The Barrens")
        end,
    },
    {
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Tirisfal Glades")
        end,
    },
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236831",
        achievementPoints = 50,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Stonetalon Mountains")
        end,
    },
    ...
    -- ASHENVALE (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236713",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Ashenvale")
        end,
    },
    {
    ...
    -- DUSKWOOD (Horde) - Adding missing tiers
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236757",
        achievementPoints = 50,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Duskwood")
        end,
    },
    {
    ...
    -- HILLSBRAD FOOTHILLS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236779",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Hillsbrad Foothills")
        end,
    },
    {
    ...
    -- THOUSAND NEEDLES (Alliance) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236848",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Thousand Needles")
        end,
    },
    {
    ...
    -- ALTERAC MOUNTAINS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236711",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Alterac Mountains")
        end,
    },
    {
        id = "zone_alterac_250",
    ...
    -- ARATHI HIGHLANDS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236712",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Arathi Highlands")
        end,
    },
    {
        id = "zone_arathi_250",
    ...
    -- DESOLACE (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236742",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Desolace")
        end,
    },
    {
    ...
    -- STRANGLETHORN VALE (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236844",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Stranglethorn Vale")
        end,
    },
    {
    ...
    -- THE HINTERLANDS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236780",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "The Hinterlands")
        end,
    },
    {
    ...
    -- TANARIS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236846",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Tanaris")
        end,
    },
    {
        id = "zone_tanaris_250",
    ...
    -- UN'GORO CRATER (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236850",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Un'Goro Crater")
        end,
    },
    {
        id = "zone_ungoro_250",
    ...
    -- FELWOOD (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236763",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Felwood")
        end,
    },
    {
        id = "zone_felwood_250",
    ...
    -- BADLANDS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236716",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Badlands")
        end,
    },
    {
    ...
    -- FERALAS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236764",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Feralas")
        end,
    },
    {
        id = "zone_feralas_250",
    ...
    -- SEARING GORGE (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236815",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Searing Gorge")
        end,
    },
    {
    ...
    -- BURNING STEPPES (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236734",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Burning Steppes")
        end,
    },
    {
    ...
    -- WESTERN PLAGUELANDS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236851",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Western Plaguelands")
        end,
    },
    {
    ...
    -- EASTERN PLAGUELANDS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236760",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Eastern Plaguelands")
        end,
    },
    {
     ...
     -- DEADWIND PASS (Contested) - All 4 tiers
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Deadwind Pass")
        end,
    },
    {
    ...
    -- WINTERSPRING (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236854",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Winterspring")
        end,
    },
    {
    ...
    -- SILITHUS (Contested) - All 4 tiers
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236829",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Silithus")
        end,
    },
    {
...

{
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236761",
        achievementPoints = 50,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Elwynn Forest")
        end,
    },
    {
    ...
    },
    {
        ...
        iconID =  "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236852",
        achievementPoints = 50,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Westfall")
        end,
    },
    {
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByTimeRangeName("night_shift") -- 10 PM to 6 AM, optimized
        end,
    },
    {
        id = "time_night_shift",
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByCombination("lunch_weekdays") -- 12-2 PM on weekdays, optimized
        end,
    },
    {
        id = "time_lunch_hour",
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByCombination("afterwork_weekdays") -- 5-10 PM on weekdays, optimized
        end,
    },
    {
        id = "time_after_work",
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByCombination("workhours_weekdays") -- 9 AM-5 PM on weekdays, optimized
        end,
    },
    {
        id = "time_work_hours",
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByTimeRangeName("early_bird")
        end,
    },
    {
        id = "time_early_bird",
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByWeekdayGroup("weekend") -- Saturday and Sunday, optimized
        end,
    },
    {
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByWeekdayGroup("weekdays") -- Monday-Friday, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            local timeStats = BPP_GetTimeBasedStats()
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsBySpecialDate("new_years_day") -- New Year's Day, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsBySpecialDate("valentines_day")
        end,
    },
    {
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsBySpecialDate("christmas") -- Christmas Day, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsBySpecialDate("new_years_eve") -- New Year's Eve, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsBySpecialCondition("friday13th") -- Friday 13th, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("january") -- January, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("february") -- February, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("march") -- March, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("april") -- April, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("may") -- May, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("june") -- June, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("july") -- July, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("august") -- August, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("september") -- September, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("october") -- October, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("november") -- November, optimized
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("december") -- December, optimized
        end,
    },
    {
        id = "name_letter_a",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("A")
        end,
    },
    {
        id = "name_letter_b",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("B")
        end,
    },
    {
        id = "name_letter_c",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("C")
        end,
    },
    {
        id = "name_letter_d",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("D")
        end,
    },
    {
        id = "name_letter_e",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("E")
        end,
    },
    {
        id = "name_letter_f",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("F")
        end,
    },
    {
        id = "name_letter_g",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("G")
        end,
    },
    {
        id = "name_letter_h",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("H")
        end,
    },
    {
        id = "name_letter_i",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("I")
        end,
    },
    {
        id = "name_letter_j",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("J")
        end,
    },
    {
        id = "name_letter_k",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("K")
        end,
    },
    {
        id = "name_letter_l",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("L")
        end,
    },
    {
        id = "name_letter_m",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("M")
        end,
    },
    {
        id = "name_letter_n",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("N")
        end,
    },
    {
        id = "name_letter_o",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("O")
        end,
    },
    {
        id = "name_letter_p",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("P")
        end,
    },
    {
        id = "name_letter_q",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("Q")
        end,
    },
    {
        id = "name_letter_r",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("R")
        end,
    },
    {
        id = "name_letter_s",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("S")
        end,
    },
    {
        id = "name_letter_t",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("T")
        end,
    },
    {
        id = "name_letter_u",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("U")
        end,
    },
    {
        id = "name_letter_v",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("V")
        end,
    },
    {
        id = "name_letter_w",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("W")
        end,
    },
    {
        id = "name_letter_x",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("X")
        end,
    },
    {
        id = "name_letter_y",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("Y")
        end,
    },
    {
        id = "name_letter_z",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameStartingWith("Z")
        end,
    },
    {
        id = "name_length_2",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameLength(2)
        end,
    },
    {
        id = "name_length_3",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameLength(3)
        end,
    },
    {
        id = "name_length_12",
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithNameLength(12)
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithSpecialCharsInName()
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsWithAccentCharsInName()
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("january")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("february")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("march")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("april")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("may")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("june")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("july")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("august")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("september")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("october")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("november")
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountKillsByMonthName("december")
        end,
    },
    {
    ...
    -- Streak Achievements
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountConsecutiveDaysWithMinKills(10) or 0
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountConsecutiveDaysWithMinKills(25) or 0
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountConsecutiveDaysWithMinKills(50) or 0
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountConsecutiveDaysWithMinKills(100) or 0
        end,
    },
    {
    ...
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountTotalDaysWithMinKills(10) or 0
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountTotalDaysWithMinKills(25) or 0
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountTotalDaysWithMinKills(50) or 0
        end,
    },
    {
        ...
        progress = function(achievement, stats)
            return BPP_CountTotalDaysWithMinKills(100) or 0
        end,
    },
    -- =====================================================
    ...
    -- STORMWIND (For Horde)
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Stormwind City")
        end,
    },
    {
    ...
    -- IRONFORGE (For Horde)
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236805",
        achievementPoints = 25,
        targetValue = 50,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Ironforge")
        end,
    },
    {
    ...
    -- DARNASSUS (For Horde)
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236740",
        achievementPoints = 25,
        targetValue = 50,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Darnassus")
        end,
    },
    {
    ...
    -- ORGRIMMAR (For Alliance)
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Orgrimmar")
        end,
    },
    {
    ...
    -- THUNDER BLUFF (For Alliance)
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Thunder Bluff")
        end,
    },
    {
    ...
    -- UNDERCITY (For Alliance)
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Undercity")
        end,
    },
    {
    ...
    },
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236385",
        achievementPoints = 25,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Arathi Basin")
        end,
    },
    {
        id = "bg_arathi_500",
    ...
    },
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236396",
        achievementPoints = 25,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Warsong Gulch")
        end,
    },
    {
        id = "bg_wsg_500",
    ...
    },
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236388",
        achievementPoints = 25,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Alterac Valley")
        end,
    },
    {
        id = "bg_av_500",
    ...
    -- NPC Kills: Corporal Keeshan
    {
        ...
        unlocked = false,
        completedDate = nil,
        subText = "Keeshan couldn't survive the mountains.",
        progress = function(achievement, stats)
...
-- One shared joke per tier, reused for every guild in BPP_TARGET_GUILDS.
local BPP_TARGET_GUILD_SUBTEXTS = {
...
local function BPP_SlugifyGuildName(guildName)
    return guildName:lower():gsub("[^%a%d]+", "")
end

local function CreateTargetGuildAchievements(guildName)
    local slug = BPP_SlugifyGuildName(guildName)

    for _, tier in ipairs(BPP_TARGET_GUILD_TIERS) do
        local achievement = {
            ...
            completedDate = nil,
            subText = function(a)
                return BPP_TARGET_GUILD_SUBTEXTS[a.targetValue](a.guildName, a.targetValue)
            end,
            progress = function(achievement, stats)
...
for _, guildName in ipairs(BPP_TARGET_GUILDS) do
