...
AchievementSystem.achievementsTbc = {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236778",
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Hellfire Peninsula")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236855",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Zangarmarsh")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Terokkar Forest")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236810",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Nagrand")
        end,
    },
    {
        id = "zone_nagrand_250",
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236719",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Blade's Edge Mountains")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236811",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Netherstorm")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236816",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Shadowmoon Valley")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236762",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Eversong Woods")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Ghostlands")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236715",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Azuremyst Isle")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Bloodmyst Isle")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetProgressForAchievementWithAllClasses(stats, BPP_GAME_VERSIONS.TBC)
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236439",
    ...
    },
    {
        ...
        description = function(a) return ("Eliminate %d Blood Elves"):format(a.targetValue) end,
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236440",
        achievementPoints = 50,
        targetValue = 2000,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236441",
        achievementPoints = 10,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236610",
        achievementPoints = 25,
        targetValue = 100,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetProgressForAllianceRacesTBC(stats)
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236611",
        ...
        progress = function(achievement, stats)
            return BPP_GetProgressForHordeRacesTBC(stats)
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        iconID = "Interface\\AddOns\\BigPPvPStats\\img\\icons\\236392",
        achievementPoints = 25,
        targetValue = 250,
        condition = function(achievement, stats)
            return achievement.progress(achievement, stats) >= achievement.targetValue
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Eye of the Storm")
        end,
    },
    {
        id = "bg_eots_500",
    ...
    -- =====================================================
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Silvermoon City")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, "Exodar")
        end,
    },
    {
        id = "city_exodar_100",
    ...
    -- RUINS OF LORDAERON
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Ruins of Lordaeron")
        end,
    },
    {
        id = "arena_ruins_100",
    ...
    -- NAGRAND ARENA
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Nagrand Arena")
        end,
    },
    {
    ...
    -- BLADE'S EDGE ARENA
    {
        ...
        progress = function(achievement, stats)
            return BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_CLASSIC, "Blade's Edge Arena")
        end,
    },
    {
    ...
    -- =====================================================
    {
        ...
        progress = function(achievement, stats)
            ...
            for _, zoneName in ipairs(outlandZones) do
                if BPP_GetZoneKills(stats, BPP_ZONE_TRANSLATIONS_TBC, zoneName) > 0 then
                    return 1
                end
            end
