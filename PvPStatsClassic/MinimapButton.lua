...
minimapButton:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine(" ")
    GameTooltip:AddLine("|cff87ceebLeft-Click:|r Statistics")
    GameTooltip:AddLine("|cff87ceebRight-Click:|r History")
    GameTooltip:AddLine("|cff87ceebCtrl+Left-Click:|r Settings")
    GameTooltip:AddLine("|cff87ceebCtrl+Right-Click:|r Achievements")
    GameTooltip:Show()
end)
