...
AchievementSystem.achievementsTbc = {
    ...
    },
    {
        ...
        completedDate = nil,
        subText = function(a)
            return ("Thrall built Nagrand Arena to honour honourable combat. You have used it to end %d people and counting. Thrall is somewhere crying into a mace and it is entirely your fault."):format(a.targetValue)
        end,
        progress = function(achievement, stats)
            return PSC_GetZoneKills(stats, PSC_ZONE_TRANSLATIONS_CLASSIC, "Nagrand Arena")
        end,
    ...
    },
    {
        ...
        completedDate = nil,
        subText = function(a)
            return ("%d kills in an arena named after sharp things used to hurt people. At this point you're not competing — you're just letting them in for sport. A formal letter of concern has been drafted. Nobody sent it."):format(a.targetValue)
        end,
        progress = function(achievement, stats)
            return PSC_GetZoneKills(stats, PSC_ZONE_TRANSLATIONS_CLASSIC, "Blade's Edge Arena")
        end,
