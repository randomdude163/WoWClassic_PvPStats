...
![Source Installation](img/Screenshots/data_import/0_show_tbc_anniversary_in_explorer.jpg)

Navigate to `WTF\Account\<your account>\SavedVariables` and create a backup of your `PvPStatsClassic.lua`file:

![Backup](img/Screenshots/data_import/0_1_backup_pvp_stats_classic_lua.jpg)
...
![Classic Client](img/Screenshots/data_import/1_show_classic_client_in_explorer.jpg)
...
![Find File](img/Screenshots/data_import/3_find_PvPStatsClassic_lua_in_the_saved_variables_folder.jpg)

Open this file with a text editor (like Notepad).

![Open File](img/Screenshots/data_import/4_open_with_notepad.jpg)
...
![Rename DB](img/Screenshots/data_import/5_add_IMPORT_to_PSC_DB.jpg)

## Step 5: Copy Data
Select **everything** in the file (Ctrl+A) and copy it (Ctrl+C or right-click -> copy).

![Copy Data](img/Screenshots/data_import/6_select_everything_and_copy.jpg)
...
![Open Target](img/Screenshots/data_import/7_open_tbc_pvp_stats_classic_lua_in_notepad.jpg)

## Step 7: Paste Import Data
Paste the copied content at the very **beginning** of the file (before the existing `PSC_DB` block).

![Paste Data](img/Screenshots/data_import/8_paste_copied_content_from_classic_lua_to_first_line_of_tbc_lua.jpg)

## Step 8: Save and Close
Save the changes to the TBC Anniversary file and close it.

![Save File](img/Screenshots/data_import/9_save_the_file_in_notepad.jpg)

Close the Classic Era file **without** saving:

![Close Files](img/Screenshots/data_import/10_close_both_files_and_discard_the_changes_to_classic_lua_file.jpg)

## Step 9: Launch Game
Start TBC Anniversary.

![Start Game](img/Screenshots/data_import/11_start_tbc_anniversary.jpg)
...
![Confirm Import](img/Screenshots/data_import/12_login_wait_for_the_popup_make_sure_the_data_is_plausible_and_click_yes.jpg)
