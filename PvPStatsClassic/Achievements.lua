    ...
    -- Paladin Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("They say 'I just want everyone to get along' while reporting half the BG for language. You’ve defeated %d Paladins who unironically post minion memes and call every woman “m’lady” in raid chat."):format(a.targetValue) end,
}, {
    id = "class_paladin_1",
    title = "Bubble Popper",
    description = function(a) return ("Slay %d Paladins"):format(a.targetValue) end,
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Divine Shield bubbles popped! Turns out, the Light doesn't save them when [YOUR NAME] is around."):format(a.targetValue) end,
}, {
    id = "class_paladin_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Paladins discovered their Hearthstone was on cooldown. The Light abandoned them faster than their guild after a wipe."):format(a.targetValue) end,
}, {
    id = "class_paladin_3",
...
}, -- Priest Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Priests exorcised—and not just from the battlefield. These armchair therapists are one failed psych degree away from charging guildmates hourly. Every time you crit them, they ask if you're projecting."):format(a.targetValue) end,
}, {
    id = "class_priest_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Priests discovered that healing can't fix death! Their last confession? 'I should have rolled a Warlock.'"):format(a.targetValue) end,
}, {
    id = "class_priest_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Priests found out prayer cooldowns are longer than death timers! The Light's HR department is swamped with resignation letters."):format(a.targetValue) end,
}, {
    id = "class_priest_3",
...
}, -- Druid Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("Feral Druids brag about their movement speed—until they realize they’ve sprinted straight into %d unavoidable deaths. Some say Travel Form is fast. You know what’s faster? A corpse run."):format(a.targetValue) end,
}, {
    id = "class_druid_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Druids exterminated! Cat form, bear form, dead form – you've seen them all. PETA has issued a statement."):format(a.targetValue) end,
}, {
    id = "class_druid_3",
...
}, -- Shaman Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Shamans eliminated! These wannabe Avatars binge-watched too many cartoons and thought they'd be bending all four elements in-game. Reality hit harder than your weapon when they discovered their totems don't actually shoot fire or create tsunamis. They spend most raids frantically alt-tabbing to YouTube tutorials trying to figure out what their class actually does. When asked about their role, they reply 'Yes' and then fail at all of them."):format(a.targetValue) end,
}, {
    id = "class_shaman_1",
    title = "Totem Kicker",
    description = function(a) return ("Defeat %d Shamans"):format(a.targetValue) end,
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Shamans flattened — mostly Enhancement mains who picked the spec because someone told them Windfury makes big numbers. They’re now back in retail, crying about how Classic 'isn't fair'."):format(a.targetValue) end,
}, {
    id = "class_shaman_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Shamans deleted their characters after realizing casting Lightning Bolt in melee range isn’t actually a good strategy. Their ancestors are embarrassed."):format(a.targetValue) end,
}, {
    id = "class_shaman_3",
...
}, -- Hunter Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("You’ve taken out %d Hunters who say “trust your instincts” but can’t trust themselves to park straight. They bring up Bear Grylls in Discord like it's a personality trait and probably drink their own piss “ironically.”"):format(a.targetValue) end,
}, {
    id = "class_hunter_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Hunters down. All of them thought naming their pet 'Arthas' made them deep, and that spelling 'Légolâs' with special characters made them original. Congratulations — you just wiped out the world's largest unpaid cosplay convention."):format(a.targetValue) end,
}, {
    id = "class_hunter_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Hunters eliminated—most didn’t even notice. Their corpses still have Auto Shot toggled on. And the other half are still backpedaling to the graveyard."):format(a.targetValue) end,
}, {
    id = "class_hunter_3",
    title = "Click… No Ammo",
    description = function(a) return ("Take down %d Hunters"):format(a.targetValue) end,
...
}, -- Warrior Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Warriors down! These gym bros spent more time flexing in Ironforge than learning their rotation. Their emotional range is limited to 'mad,' 'hangry,' and 'where heals?' They consider counting to 10 as advanced mathematics and think reading quest text is for roleplayers. They also believe that 'PvP' stands for 'Protein vs. Pre-workout.'"):format(a.targetValue) end,
}, {
    id = "class_warrior_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Warriors deleted! These mouth-breathing keyboard smashers think strategy means hitting whatever isn't on cooldown. Their collective IQ is lower than their average item level, and that's saying something after you've repeatedly ganked them naked. The warrior's guild is hiring anyone with a pulse now—previous candidates eliminated by natural selection and your weapon."):format(a.targetValue) end,
}, {
    id = "class_warrior_3",
...
}, -- Mage Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Mages deleted! Each one was three credits short of a philosophy degree but will lecture you about existentialism anyway. These self-proclaimed intellectuals memorized all their 'actually' rebuttals from Reddit posts and believe their IQ is 'too high to measure.'"):format(a.targetValue) end,
}, {
    id = "class_mage_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("Local inn reports %d frozen mage corpses! Their Ice Block and your Frostnova melted faster than their hopes of survival. At least they're well preserved."):format(a.targetValue) end,
}, {
    id = "class_mage_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("These %d mages learned that Pyroblast's cast time is longer than their life expectancy! Their last words were 'Just one more second...'"):format(a.targetValue) end,
}, {
    id = "class_mage_3",
...
}, -- Rogue Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("Found %d rogues the hard way! Their stealth wasn't as good as they thought - maybe they should've spent more time practicing and less time ganking lowbies?"):format(a.targetValue) end,
}, {
    id = "class_rogue_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Rogues got outplayed so hard, even Vanish couldn’t save them. The poison vendor is now offering a ‘No Refunds’ policy."):format(a.targetValue) end,
}, {
    id = "class_rogue_3",
...
}, -- Warlock Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Warlocks sent their demons back to HR! Soul Shards now come with a money-back guarantee."):format(a.targetValue) end,
}, {
    id = "class_warlock_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Warlocks perished, and not a single Soulstone in sight. Their last words? 'Bro, I thought you had one on me.'"):format(a.targetValue) end,
}, {
    id = "class_warlock_3",
    title = "Curse you!",
    description = function(a) return ("Banish %d Warlocks"):format(a.targetValue) end,
...
}, -- Female Gender Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d female characters slain! Equal opportunity combat at its finest. You've sent these ladies to respawn and didn't even hold the graveyard gate open for them."):format(a.targetValue) end,
}, {
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d female characters deleted with extreme prejudice. The Ironforge 'Women's Protection Society' has placed a bounty on your head. Prepare for the shitstorm."):format(a.targetValue) end,
}, {
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d female characters obliterated! Your battle cry 'Equal rights means equal fights!' echoes across Azeroth. You've been banned from every tavern in Stormwind."):format(a.targetValue) end,
}, {
...
-- Male Gender Achievement
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d husbands never made it home for dinner! Their wives are spending the Goblin Life Insurance payouts at the Auction House."):format(a.targetValue) end,
}, {
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d male characters destroyed! You're single-handedly responsible for a dating app boom in Azeroth. Lonely hearts everywhere."):format(a.targetValue) end,
}, {
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d males sent to their maker! The orphanages are overflowing and the wedding ring market has crashed. Economics, baby!"):format(a.targetValue) end,
}, {
...
}, -- Zone-specific Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("After %d deaths in Elwynn, local humans are painting themselves green and practicing their 'zug zug'! Goldshire Inn's new special: 'Reroll Horde, Get Free Hearthstone to Durotar.' Even Marshal Dughan is considering a career in Orgrimmar."):format(a.targetValue) end,
}, {
...
}, -- Total Kills Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d bodies dropped! Barrens chat has already moved on to debating whether you’re a bot, a multiboxer, or just deeply unhinged."):format(a.targetValue) end,
}, {
    id = "kills_total_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d kills! Spirit Healers are now offering you a commission for each body you send their way. The local gravediggers have named their shovels after you."):format(a.targetValue) end,
}, {
    id = "kills_total_3",
...
}, -- Unique Player Kills Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d different players have fallen to you. At this point, you’re less of a PvPer and more of an extinction event. Azeroth is running out of fresh faces, and you’re the reason why."):format(a.targetValue) end,
}, {
    id = "kills_unique_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d unique victims and counting! Players are now selling 'I Survived [YOUR NAME]' t-shirts - except none of them actually survived."):format(a.targetValue) end,
}, {
    id = "kills_unique_3",
...
-- Human Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Humans dispatched! Their racial ability 'Every Man for Himself' should really be called 'Every Man for the Graveyard.' So much for human ingenuity."):format(a.targetValue) end,
}, {
    id = "race_human_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Humans deleted! The most basic race in Azeroth, chosen by people who couldn’t be bothered to click twice. They died as they lived—completely unremarkable."):format(a.targetValue) end,
}, {
    id = "race_human_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Humans down! They picked the ‘best PvP race’ for the racial bonuses but forgot to read the part about positioning and cooldowns."):format(a.targetValue) end,
}, {
    id = "race_human_3",
    title = "Uniqueness",
    description = function(a) return ("Eliminate %d Humans"):format(a.targetValue) end,
...
-- Night Elf Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Night Elves slain! Half were dudes with 'Illidan' in their names trying to dual-wield everything, the other half were female characters made by players who just discovered hormones. Their deaths were as dramatic as their /dance animations. Time to let go of that purple dream, boys—Tyrande's not checking your DMs."):format(a.targetValue) end,
}, {
    id = "race_nightelf_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Night Elves eliminated! They thought they disappeared… but all you saw was a free honor kill waiting to happen."):format(a.targetValue) end,
}, {
    id = "race_nightelf_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Night Elf hippies permanently recycled back to nature! These Whole Foods shopping, kombucha brewing, crystal-healing enthusiasts thought their organic armor and free-range weapons would save them. They were too busy forming drum circles and protesting Goblin deforestation to notice your approach. Their last words were 'Namaste... in the graveyard.' Turns out their carbon footprint is now zero - just like their kill/death ratio."):format(a.targetValue) end,
}, {
    id = "race_nightelf_3",
...
-- Dwarf Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Dwarves hammered down! These walking Scottish stereotypes died mumbling something that might have been a battle cry or just ordering another ale—nobody could understand a word through that accent. Next time they'll think twice before typing 'AYE LADDIE!' in every chat channel."):format(a.targetValue) end,
}, {
    id = "race_dwarf_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Dwarves crushed! Short, stout, and now six feet under. Their ‘legendary resilience’ apparently doesn’t apply when getting farmed for honor."):format(a.targetValue) end,
}, {
    id = "race_dwarf_2",
    title = "Beard Trimmer",
    description = function(a) return ("Eliminate %d Dwarves"):format(a.targetValue) end,
...
-- Gnome Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Gnomes stepped on! All their engineering gadgets failed when they needed them most. At least they make cute decorations for your kill count."):format(a.targetValue) end,
}, {
    id = "race_gnome_1",
    title = "Pest Control",
    description = function(a) return ("Eliminate %d Gnomes"):format(a.targetValue) end,
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Gnomes punted out of existence! Their last words? 'Size doesn’t matter!' Their respawn timer says otherwise. So do their wifes."):format(a.targetValue) end,
}, {
    id = "race_gnome_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Gnomes deleted. You’ve wiped more STEM majors than a Silicon Valley hiring freeze. Their gadgets couldn’t save them, and their last words were all keyboard macros no one understood"):format(a.targetValue) end,
}, {
    id = "race_gnome_3",
...
-- Orc Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Orcs sent to meet their ancestors! Their blood fury only made your attacks hurt more. So much for orcish resilience when faced with your wrath."):format(a.targetValue) end,
}, {
    id = "race_orc_1",
    title = "Green Peace",
    description = function(a) return ("Eliminate %d Orcs"):format(a.targetValue) end,
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("Zug zug? More like zug zugged into the grave. %d Orcs charged in, expecting an easy win—turns out, yelling ‘Lok’tar Ogar!’ doesn’t make you invincible."):format(a.targetValue) end,
}, {
    id = "race_orc_2",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Orcs have rage-quit after meeting you! These keyboard smashers with names like 'Gorégut' and 'Axemastr' spent more time perfecting their /flex macro than learning to dodge. Greenpeace has formally requested you stop this endangered species extinction event. Their Blood Fury racial activated IRL as they typed angry whispers to you from the graveyard."):format(a.targetValue) end,
}, {
    id = "race_orc_3",
...
-- Undead Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Undead returned to their graves! Turns out being already dead doesn't make you immune to a second death. Will of the Forsaken? More like Will to Respawn."):format(a.targetValue) end,
}, {
    id = "race_undead_1",
    title = "Double Dead",
    description = function(a) return ("Eliminate %d Undead"):format(a.targetValue) end,
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Forsaken sent back to the character creation screen. Turns out, playing ‘the most hardcore race’ doesn’t make you any less of a free HK. Sylvanas won’t miss them—she doesn’t even miss her own people."):format(a.targetValue) end,
}, {
    id = "race_undead_2",
    title = "Zombies't",
    description = function(a) return ("Eliminate %d Undead"):format(a.targetValue) end,
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Forsaken ganked! They picked Undead to look cool and ended up looking clueless. No, ‘Will of the Forsaken’ doesn’t make you invincible—if it did, they wouldn’t all be face-down in the dirt"):format(a.targetValue) end,
}, {
    id = "race_undead_3",
...
-- Troll Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Trolls made to stay dead! Their regeneration couldn't keep up with your damage output. The Darkspear tribe is sending angry letters about their population decline."):format(a.targetValue) end,
}, {
    id = "race_troll_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("Da spirits be VERY angry wit' you mon, after %d trolls found out their regeneration can't outpace your damage output. Their hunched backs didn't help them dodge your attacks—just made it easier for you to spot them from a distance. Zul'jin is considering therapy after watching your killing spree. Stay away from da voodoo!"):format(a.targetValue) end,
}, {
    id = "race_troll_2",
...
-- Tauren Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Tauren sent to the great plains in the sky! Those war stomps were no match for your superior combat skills. The Earth Mother has filed a complaint about your treatment of her children."):format(a.targetValue) end,
}, {
    id = "race_tauren_1",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Tauren down! These walking steaks chose the biggest hitbox in the game then complained when your attacks connected. McDonald's just offered you a sponsorship deal after your record-breaking beef production. The 'got milk?' campaign is suing you for destroying their mascots. Next time they'll think twice before picking a race that can be seen from the other continent."):format(a.targetValue) end,
}, {
    id = "race_tauren_2",
    title = "No More Bull",
    description = function(a) return ("Eliminate %d Tauren"):format(a.targetValue) end,
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d Tauren players got exactly what they deserved for picking the 'gentle giant' stereotype! Their 5% bonus health just meant they died 3 seconds slower while panic-pressing War Stomp. The real stampede was them rushing to the forums to complain about 'unfair pvp balance.'"):format(a.targetValue) end,
}, {
    id = "race_tauren_3",
...
}, -- Guild Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d so-called 'guildmates' slaughtered! Turns out, that guild tag above their heads didn’t make them any less squishy. Maybe they should try a PvE guild—less world PvP, more coping in raid chat."):format(a.targetValue) end,
}, {
    id = "kills_guildless",
...
-- }, -- Kill Streak Achievements
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d players deleted in a row! The graveyard is installing a '[YOUR NAME] Express Lane' with a self-checkout option."):format(a.targetValue) end,
},
{
    id = "kills_streak_50",
    title = "Crime Scene",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d consecutive kills! Azeroth's investigators are gathering evidence, but all the witnesses keep mysteriously disappearing."):format(a.targetValue) end,
},
{
    id = "kills_streak_75",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d kills without dying? Players are filing tickets claiming you're hacking. Blizzard responded: 'No, they're just that good.'"):format(a.targetValue) end,
},
{
    id = "kills_streak_100",
    title = "TRIPLE D!!!",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("You've killed more players than some indie games have sales. Enemy raid leaders reference you like you're Voldemort — 'He-Who-Wipes-Raid-Groups.'' Even your local WiFi provider flagged you as a DDoS threat."):format(a.targetValue) end,
},
{
    id = "kills_streak_125",
    title = "PvP Plague",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("You're not a player anymore—you're a server-wide debuff. Whole zones avoid you like it's patch day. %d kills and not a single scratch? That’s not PvP. That’s population control."):format(a.targetValue) end,
},
{
    id = "kills_streak_150",
    title = "Fine Wine",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d uninterrupted kills! You're not just killing players—you're killing server populations. Like a fine wine, your murder spree only improves with time."):format(a.targetValue) end,
},
{
    id = "kills_streak_175",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d bodies and counting! Like the legendary Alterac Valley weapon, you've become a force of nature—slow, powerful, and absolutely devastating. The Immovable Object has finally met its match, and it's your kill streak. Players have started putting 'killed by [YOUR NAME]' in their forum signatures as a badge of honor."):format(a.targetValue) end,
},
{
    id = "kills_streak_200",
    title = "/flex",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d unbroken kills! Your /flex emote now causes a 10-yard fear. Even raid bosses check their aggro tables when you log in. Blizzard added a new GM macro: /who [YOUR NAME] – for threat assessment."):format(a.targetValue) end,
},
{
    id = "kills_multi_3",
    title = "Triple Kill!",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("ACE! Three champions... er, players... fell to your blade in quick succession. The enemy team is crying 'nerf [YOUR NAME]' in all chat. Your Summoner Score is rising!"):format(a.targetValue) end,
},
{
    id = "kills_multi_4",
    title = "QUADRA KILL!",
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("The crowd goes wild as you secure your fourth elimination! 'GG [YOUR NAME] diff' echoes across Azeroth. The enemy team is calling for a surrender vote while spamming 'Report jungler no ganks' in chat."):format(a.targetValue) end,
},
{
    id = "kills_multi_5",
    title = "PENTAKILL!!",
...
},
{
    ...
    unlocked = false,
    completedDate = nil,
    subText = function(a) return ("%d level ?? enemies deleted! While lesser mortals flee at the sight of a ?? mark, you hunt them for sport. These walking raid bosses thought their level advantage made them untouchable and overconfident — until they met [YOUR NAME]."):format(a.targetValue) end,
},
}
